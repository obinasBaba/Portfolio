...
type MotionValueContextType = {
  ...
  registerScrollRestoration: MotionValue<string | undefined>
  mouse: {
...
export const MotionStateWrapper = ({ children }) => {
  ...
  const registerScrollRestoration = useMotionValue(undefined)
  ...
  useLayoutEffect(() => {
    const updateMouseMotionValue = ev => {

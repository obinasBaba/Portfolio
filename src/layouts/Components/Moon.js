            ...
            <g id="Moon_and_Moonlight" transform="translate(-367 238)">
              ...
              </g>
              {
                showMoon &&   <g id="moon" transform="translate(746 141)">
                  ...
                  <path id="Path_74"
                        data-name="Path 74" d="M199.374,191.592a59.5,59.5,0,1,1-59.5-59.5,59.5,59.5,0,0,1,59.5,59.5m97.58-95a38.08,38.08,0,1,1-38.08-38.08,38.08,38.08,0,0,1,38.08,38.08m-3.709,105a24.371,24.371,0,1,1-24.371-24.371,24.371,24.371,0,0,1,24.371,24.371" fill="rgba(230,230,230,0.3)" fill-rule="evenodd"/>
                </g>
              }
            </g>
          </svg>

...
import { container, placeholderImg, vid, wrapper } from "./videoplayer.module.scss";
      ...
      >
        ...
        <div className={wrapper}>
...

          {
            ...
            true &&
            <div className={clsx( [placeholderImg] )} style={{ opacity: loaded ? 0 : 1 }}>
          ...
          <video className={vid} preload="metadata" muted={true} loop={true} playsInline={true}
                 {...props?.vidProps}
                 ref={vidRef}
          >

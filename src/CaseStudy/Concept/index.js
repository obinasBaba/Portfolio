    ...
    <ConceptContainer >
      <ConceptTxtWrapper maxWidth='xl' fixed={true} >
        ...
        <Typography className='concept-desc' >
          ...
          to create a stylish atmosphere with a Wesctern feel rather that inorganic
          atmosphere of a typical hair salon.
          for the key visuals, i Photographed the tools and hair styleing products that i
          usually use, and adjusted theme to look like a magazine while.
        </Typography>

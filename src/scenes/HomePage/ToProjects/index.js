        ...
        <div className={text}>
          <div className={aimTxtWrapper}>
            <Typography className={aimText} gutterBottom variant="body1">
              ...
              One that capture your imagination, One that drive your business
              forward with strong traffic, One that ...
            </Typography>

            <Typography className={aimText} variant="body1">
              My portfolio is really quite diverse in range containing
              everything from simple API design to fully-fledged web-apps and
              deployment setup to landing pages that I have simply created for
              fun. I would prefer to let my work speak for itself so feel free

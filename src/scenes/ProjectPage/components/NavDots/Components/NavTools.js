...
export function AnchorDot({onClick, anchor}) {
  return (
    <BigDotContainer className='anchorDot'
        ...
        <motion.svg layout xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9">
...
export function DottedLine() {
  return (
    ...
    >
      <motion.svg layout xmlns="http://www.w3.org/2000/svg" width="1.691" height="35.521" viewBox="0 0 1.691 35.521">
...
export function Thumb({isLast, isFirst}) {
  return (
    <ThumbContainer className='thumb'
                    ...
                    layoutId='thumb'
    >
      <motion.svg xmlns="http://www.w3.org/2000/svg"   width="46" height="58" viewBox="0 0 46 58">
        <defs>
        ...
        <g id="thumb" transform="translate(-65.268 -419.807)">
          <g id="Group_40" data-name="Group 40" transform="translate(81.62 420)">
            ...
            {!isFirst && <path id="arrow-up" d="M4,0,8,7H0Z" transform="translate(2.648 -0.193)" fill="url(#linear-gradient)"/>}

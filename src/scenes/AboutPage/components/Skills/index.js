    ...
    return (
        <SkillsContainer maxWidth={matches ? 'xl' : 'lg'}>
            ...
            <Text>
                ...
                design and development processes which help me crafting
                <span className='contrast'> beautiful web product</span> focused on simplicity and purpose is
                what i enjoy most in
                my work
            </Text>

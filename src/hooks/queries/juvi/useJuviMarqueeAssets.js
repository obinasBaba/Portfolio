...
const useMarqueeAssets = () => {
  return useStaticQuery(graphql`
      query {
          ...
          productDetailPage: file(relativePath: { eq: "juvi-haus/marquee/product-detail-page.png" }) {
              publicURL
              name
              ...homeWorksBigImage
          }

          productDetail: file(relativePath: { eq: "juvi-haus/marquee/product-detail.png" }) {
              publicURL
              name
              ...homeWorksBigImage
          }
          ...
          testimonial: file(relativePath: { eq: "juvi-haus/marquee/testimonial.png" }) {
              publicURL
              name
              ...homeWorksBigImage
          }

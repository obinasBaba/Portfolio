...
const NavBtn = ({ isWhite, toggleMenu, pos = {}, menuIsOpen }) =>
  ...
  (
    ...
    >
      ...
      <svg xmlns='http://www.w3.org/2000/svg'
           className={clsx({ [menuOpen]: menuIsOpen })}
        ...
        <g id='AlienFace' transform='translate(-550.368 -1104.358)'>
          ...
          <path id='Path_258' data-name='Path 258'
                d='M559.649,1116.577a17.322,17.322,0,0,1,7.015-5.42'
                transform='translate(3.144 1.297)' fill='none'
                stroke='var(--theme)' strokeLinecap='round'
                strokeWidth='2' />
          <path id='Path_259' data-name='Path 259'
                d='M560.218,1113.088a3.513,3.513,0,0,1,.163-.355,5.164,5.164,0,0,1,1.071-1.409'
                transform='matrix(0.995, 0.105, -0.105, 0.995, 118.2, -43.795)'
          ...
          <path id='Path_260' data-name='Path 260'
                ...
                transform='matrix(0.921, 0.391, -0.391, 0.921, 507.992, -109.438)'
                fill='none' stroke='var(--theme)'
                strokeLinecap='round' strokeWidth='2' />
          <path id='Path_263' data-name='Path 263'
                d='M560.218,1113.085a3.636,3.636,0,0,1,.15-.355,5.132,5.132,0,0,1,.988-1.407'
                transform='matrix(0.921, 0.391, -0.391, 0.921, 480.201, -108.772)'
                fill='none' stroke='var(--theme)'
                strokeLinecap='round' strokeWidth='2' />
        </g>
      </svg>

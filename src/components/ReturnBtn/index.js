    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.path id="Path_4" data-name="Path 4" d="M0,0H18.156" transform="translate(532 2088.538)"
                       fill="none" stroke="#fff" stroke-width="1"
                       variants={pathVariant}
                       transition={pathTransition}
          />
          <motion.path id="Path_3" data-name="Path 3" d="M7.085,0,0,7.085" transform="translate(531.115 2081.763)"
                       fill="none" stroke="#fff" stroke-width="1"
                       variants={pathVariant}
                       transition={pathTransition}
          />
          <motion.path id="Path_2" data-name="Path 2" d="M7.085,0,0,7.085" transform="translate(529.343 2079.992)"
                       fill="none" stroke="#fff" stroke-width="1"
                       variants={pathVariant}
                       transition={pathTransition}
          />
          <motion.path id="Path_5" data-name="Path 5" d="M7.085,0H0" transform="translate(543.071 2090.62)"
                       fill="none" stroke="#fff" stroke-width="1"
                       variants={pathVariant}
                       transition={pathTransition}
          />
          <motion.path id="Path_6" data-name="Path 6" d="M7.085,7.085,0,0" transform="translate(531.115 2088.273)"
                       fill="none" stroke="#fff" stroke-width="1"
                       variants={pathVariant}
                       transition={pathTransition}
          />

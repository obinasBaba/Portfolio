...
const CloseContainer = styled(motion.div)`
  ...
  cursor: pointer;
  z-index: 300;
  top: ${({ pos }) => pos.top || "2.2rem"};
  right: ${({ pos }) => pos.right || "2rem"};
  left: ${({ pos }) => pos.left};
      ...
      >
        <g id="Group_1" data-name="Group 1" transform="translate(-671 -303)">
          <motion.g
            id="Path_4"
            data-name="Path 4"
            transform="translate(671 303)"
            fill="rgba(50,52,77,0)"
            custom={{ hoverFill: fillCrl }}
          ...
          <motion.path
            id="Path_2"
            data-name="Path 2"
            d="M703.5,339.745v7.509"
            transform="translate(445.596 -402.876) rotate(45)"
            fill="none"
            stroke={pathCrl}
            strokeWidth="1"
            custom={{ hoverClr: pathHoverClr }}
          ...
          <motion.path
            ...
            data-name="Path 3"
            d="M703.5,339.745v7.509"
            transform="translate(450.906 -408.186) rotate(45)"
            fill="none"
            stroke={pathCrl}
            strokeWidth="1"
            custom={{ hoverClr: pathHoverClr }}
          ...
          <motion.path
            ...
            data-name="Path 2"
            d="M703.5,339.745v7.509"
            transform="translate(-34.876 592.023) rotate(-45)"
            fill="none"
            stroke={pathCrl}
            strokeWidth="1"
            custom={{ hoverClr: pathHoverClr }}
          ...
          <motion.path
            ...
            data-name="Path 3"
            d="M703.5,339.745v7.509"
            transform="translate(-40.186 586.713) rotate(-45)"
            fill="none"
            stroke={pathCrl}
            strokeWidth="1"
            custom={{ hoverClr: pathHoverClr }}

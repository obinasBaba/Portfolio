  ...
  , function(t, e, n) {
    ...
    window.tram = function(t) {
      ...
      var C = e.frame = function() {
        ...
        , P = l(L, function(e) {
        function n(e, n) {
          var i = t.data(e, m) || t.data(e, m, new L.Bare);
        ...
        t.init = function() {
          ...
          K.perspective && H.perspective && (this.current.perspective = H.perspective,
        ...
        e.init = function(t) {
          ...
          e.play = function() {
            var t;
            this.active || (this.start || (this.start = q()),
              this.active = !0,
              t = this,
            1 === u.push(t) && C(n))
          }
      ...
      T.transform && T.backface && (K.z = [x, "translateZ"],
        K.rotateZ = [k],
        K.scaleZ = [g],
        K.perspective = [y]);
      var J = /ms/
 ...
 */
  ...
  , function(t, e, n) {
    ...
    r.define("forms", t.exports = function(t, e) {
        var n, o, a, s, u, c = {}, l = t(document), f = window.location, d = window.XDomainRequest && !window.atob, h = ".w-form", p = /e(-)?mail/i, m = /^\S+@\S+$/, v = window.alert, w = r.env(), g = /list-manage[1-9]?.com/i, b = e.debounce(function() {
        ...
        function y(e, n) {
            ...
            r.fileUploads.each(function(e) {
              !function(e, n) {
                if (!n.fileUploads || !n.fileUploads[e])
                  return;
                var i, r = t(n.fileUploads[e]), o = r.find("> .w-file-upload-default"), a = r.find("> .w-file-upload-uploading"), s = r.find("> .w-file-upload-success"), c = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"), f = o.find(".w-file-upload-label"), d = f.children(), h = c.find(".w-file-upload-error-msg"), p = s.find(".w-file-upload-file"), m = s.find(".w-file-remove-link"), v = p.find(".w-file-upload-file-name"), g = h.attr("data-w-size-error"), b = h.attr("data-w-type-error"), y = h.attr("data-w-generic-error");
                if (w)
          ...
          r.handler = null,
            ...
            g.test(s) ? r.handler = z : s || (o ? r.handler = S : b())
        }
        function x(t) {
